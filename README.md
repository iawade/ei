...
```
cd existing_repo
git remote add origin https://git.icr.ac.uk/iwade/smarca4_related.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.icr.ac.uk/iwade/smarca4_related/-/settings/integrations)
